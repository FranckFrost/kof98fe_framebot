    ...
    try {
      ...
      if (idle === "yes") {
        ...
        if (hitboxes.length === 0) {
          embed.addField('No image was found for this move', 'Feel free to share with the [developers](https://github.com/FranckFrost/kof98fe_framebot/issues) if you have one.', true);
        } else {
          let ind = "url\":\""
