  ...
  async execute(interaction) {
    ...
    fs.readFile("./assets/framedata98fe.json", "utf8", (err, jsonObject) => {
      ...
      try {
        ...
        return interaction.reply('There was an error while processing your **frames** request, reach out to <@259615904772521984>. Refer to the [Google sheet](https://docs.google.com/spreadsheets/d/100XfeqQCZB7uaeg9DJ3yWIIu6lHLbhdhs7B8b8eWRpY) to look for the data.');
      }
    });
  },
